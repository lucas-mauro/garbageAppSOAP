...
public class AddRecyclingToUserResponse implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/garbageAppFile/", "addRecyclingToUserResponse", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":addRecyclingToUserResponse", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "addRecyclingToUserResponse",
						xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static AddRecyclingToUserResponse parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			AddRecyclingToUserResponse object = new AddRecyclingToUserResponse();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"addRecyclingToUserResponse".equals(type)) {
							...
							return (AddRecyclingToUserResponse) org.example.www.garbageappfile.ExtensionMapper
