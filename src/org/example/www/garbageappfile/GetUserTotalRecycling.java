 ...
 */
            ...
            /**
            *  GetUserTotalRecycling bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetUserTotalRecycling
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getUserTotalRecycling",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getUserTotalRecycling",
    ...
    public static class Factory{
        ...
        */
        public static GetUserTotalRecycling parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserTotalRecycling object =
                new GetUserTotalRecycling();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getUserTotalRecycling".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetUserTotalRecycling)org.example.www.garbageappfile.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
