...
public class UserRecycling implements org.apache.axis2.databinding.ADBBean {
	 ...
	 * UserRecycling Namespace URI = http://www.example.org/garbageAppFile/
	...
	protected org.example.www.garbageappfile.Material localObject;
	 ...
	 */
	public org.example.www.garbageappfile.Material getObject() {
		return localObject;
	}
	 ...
	 * @param param Object
	 */
	public void setObject(org.example.www.garbageappfile.Material param) {
		...
		public static UserRecycling parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"UserRecycling".equals(type)) {
							...
							return (UserRecycling) org.example.www.garbageappfile.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "object").equals(reader.getName())) {
					...
					object.setObject(org.example.www.garbageappfile.Material.Factory.parse(reader));
