...
public class Material implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = Material
	 * Namespace URI = http://www.example.org/garbageAppFile/ Namespace Prefix = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":Material", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "Material", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 */
		public static Material parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Material".equals(type)) {
							...
							return (Material) org.example.www.garbageappfile.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
